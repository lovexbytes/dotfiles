...
| Rolling-update strategy tightened/loosened in Helm/K8s manifest | Previous manifest + change in schema/consumer code in the same MR | Use File Access instructions from your prompt | Combination with schema change can lose in-flight traffic |
