...
Read `review-refs/context-rules/domain-invariants.md` before starting analysis. Use Wave 1 findings, `review-context.json`, and related domain tests to understand the intended invariant before reporting.
