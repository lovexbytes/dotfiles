...
Read `review-refs/context-rules/sql-data-access.md` before starting analysis. Query correctness is often not visible from the diff alone; load schema, sqlc query source, generated output, and direct callers when triggers fire.
