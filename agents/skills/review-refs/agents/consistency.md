...
Read `review-refs/context-rules/consistency.md` before starting analysis. You will almost always need to load additional files to trace call chains, using the File Access instructions provided in your prompt.
